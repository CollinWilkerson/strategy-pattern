...
namespace Chapter.Decorator
{
    public class BikeWeapon : MonoBehaviour
    {
        ...
        public WeaponAttachment thirdAttachment;
        ...
        void OnGUI()
        {
            ...
            if (thirdAttachment && _isDecorated)
                GUI.Label(
                    new Rect(5, 190, 200, 100),
                    "Tirtiary Attachment: " + thirdAttachment.name);
        }
        ...
        //creates a new weapon with the decorated attachment
        //because the decorated weapon is also a weapon, this can stack infinitely
        public void Decorate() {
            if (mainAttachment && !secondaryAttachment && !thirdAttachment)
                _weapon = 
            ...
            if(mainAttachment && secondaryAttachment && thirdAttachment)
                _weapon =
                    new WeaponDecorator(
                        new WeaponDecorator(
                            new WeaponDecorator(
                                _weapon, mainAttachment), secondaryAttachment), thirdAttachment);
            _isDecorated = !_isDecorated;
        }
    }
}